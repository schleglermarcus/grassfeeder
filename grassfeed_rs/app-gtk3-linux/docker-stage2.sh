...
docker cp $(docker create --name tc grassfeeder:stage2):/usr/src/grassfeed_rs/target/gf.rpm target/ ; docker rm tc
mv target/gf.rpm  target/grassfeeder-${VERSION}-amd64.rpm
