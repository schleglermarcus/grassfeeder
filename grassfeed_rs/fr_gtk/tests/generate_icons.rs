...
// use logger_config::setup_logger;
use std::fs::File;
use std::io::Write;
use ui_gtk::iconloader::IconLoader;

const ICONS_FOLDER: &str = "src/icons/";
...
fn generate_icons() {
    ...
    debug!(
        "GENERATE ICONS current_dir={:?} {:?} ",
        current_dir, ICONS_FOLDER
    );
    ...
    lines.push("// #  cargo test --test  generate_icons \n\n".to_string());
