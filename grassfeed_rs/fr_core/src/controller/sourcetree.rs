...
use crate::controller::subscriptions_display::SubscriptionsDisplay;
...
impl SourceTreeController {
            ...
            match job {
                SJob::NotifyTreeReadCount(subs_id, msg_all, msg_unread) => {
                    ...
                    if let Some(su_st) = o_subs_state {
                        ...
                        if !self.subscriptions_display.tree_update_one(&subs_e, &su_st) {
    ...
    pub fn feedsources_into_store_adapter(&mut self) {
        ...
        self.subscriptions_display
            .insert_tree_row(&Vec::<u16>::default(), 0);
    ...
    */
    ...
    pub fn insert_tree_row_single(&self, parent_subscr_id: isize) {
        ...
        entries.iter().enumerate().for_each(|(_n, fse)| {
            ...
            let treevalues = self.subscriptions_display.tree_row_to_values(fse, &subs_map);
            (*self.gui_val_store)
                .write()
                .unwrap()
                .insert_tree_item(path, treevalues.as_slice());
    ...
    */
    ...
    pub fn tree_store_update_one(&self, f_source_id: isize) {
        ...
        if !self.subscriptions_display.tree_update_one(&fse, &su_st) {
            self.need_check_fs_paths.replace(true);
        }
    }
    ...
    */
    ...
    fn get_next_available_subscription_id(&self) -> isize {
